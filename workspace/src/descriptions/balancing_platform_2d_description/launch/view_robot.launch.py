...
def generate_launch_description() -> LaunchDescription:
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [FindPackageShare('balancing_platform_2d_description'), 'urdf', 'robot.urdf.xacro']
            ),
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'rviz_config_file',
            default_value=PathJoinSubstitution(
                [FindPackageShare('balancing_platform_2d_description'), 'rviz', 'view_robot.rviz']
            ),
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'rviz_stylesheet',
            default_value=PathJoinSubstitution(
                [FindPackageShare('balancing_platform_2d_description'), 'rviz', 'dark.qss']
            ),
