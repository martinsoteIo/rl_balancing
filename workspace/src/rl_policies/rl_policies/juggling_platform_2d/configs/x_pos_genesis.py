...
def get_cfgs():
    ...
    env_cfg = {
        ...
        "randomization": {
            "ball_init_z_range": [0.12, 0.14],
            "ball_init_x_range": [-0.08, 0.08],
            "ball_mass_range": [0.001, 0.030], #0.015, 0.040
    ...
    reward_cfg = {
        ...
        "z_min_alive": 0.026,
        "tracking_sigma": 0.06,        # antes 0.001  -> mucho más ancho
        "stability_sigma": 0.05,       # antes 0.08   -> más tolerancia
        "success_x_tol": 0.003,         # tolerancias más realistas para fase 1
        "success_vz_tol": 0.003,
        "reward_scales": {
            # "action_rate": -0.5, # -0.005
            "similar_to_default": 0.1,
            "tracking_x": 5.0,
            "stabilize_x_velocity": 1.0,
            "success_event": 10.0,
            "fall_event": -150.0,
        },
    }
