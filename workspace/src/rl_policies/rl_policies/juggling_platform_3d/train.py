...
def main():
    ...
    if args.env_name == "xy_pos":
        from rl_policies.juggling_platform_3d.envs.xy_pos_env import XPos3DEnv
        from rl_policies.juggling_platform_3d.configs.xy_pos_config import get_cfgs, get_train_cfg
        env_class = XPos3DEnv
        ...
        from rl_policies.juggling_platform_3d.configs.xy_pos_config_mass_friction import get_cfgs, get_train_cfg
        env_class = XPos3DEnv
        get_cfgs_fn = get_cfgs
        get_train_cfg_fn = get_train_cfg
