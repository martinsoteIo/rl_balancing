...
def main():
    ...
    if args.env_name == "x_pos":
        from rl_policies.balancing_platform_2d.envs.x_pos_env_genesis import XPos2DEnv
        from rl_policies.balancing_platform_2d.configs.x_pos_genesis import get_cfgs, get_train_cfg
        env_class = XPos2DEnv
